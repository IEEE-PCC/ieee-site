...
<main>
	<footer class="bg-[#1e73ae] p-10 shadow-lg">
		<div class="grid grid-cols-1 sm:grid-cols-3 gap-8 text-white">
			...
			<div>
				...
				<p class="text-sm leading-relaxed">
					IEEE Student Branch – Empowering future engineers through innovation, learning, and professional development.
				</p>
			</div>
		...
		<!-- Copyright -->
		<p class="mt-8 text-center text-xs text-white border-t border-white/20 pt-4">
